...
@NamedQueries({
    ...
    @NamedQuery(
            name = JpaConst.Q_REP_GET_ALL_DEPARTMENT,
            query = JpaConst.Q_REP_GET_ALL_DEPARTMENT_DEF),
    @NamedQuery(
            name = JpaConst.Q_REP_COUNT_ALL_DEPARTMENT,
            query = JpaConst.Q_REP_COUNT_ALL_DEPARTMENT_DEF)
