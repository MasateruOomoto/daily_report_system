...
public class DepartmentAction extends ActionBase {
    ...
    public void index() throws ServletException, IOException {
        ...
        int page = getPage();
        List<ReportView> reports = service.getDepartmentPerPage(loginEmployee, page);

        //ログイン中の従業員が作成した日報データの件数を取得
        long myReportsCount = service.countAllDepartment(loginEmployee);
        ...
        //一覧画面を表示
        forward(ForwardConst.FW_DEPARTMENT_INDEX);
    }
